        ...
        <div className="grid grid-cols-2 gap-3">
          {quickActions.map((action, index) => (
            <Button
              ...
              variant="ghost"
              className="h-auto p-4 flex flex-col gap-3 text-left bg-gradient-to-br from-gray-50 to-white border border-gray-200 hover:shadow-md hover:scale-[1.02] transition-all duration-300 hover:border-gray-300"
            >
