  ...
  return (
    <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
      <CardContent className="p-8">
        <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Your Wellness Overview</h2>
          <p className="text-gray-600">Track your mental health progress and achievements</p>
        </div>
          ...
          {metrics.map((metric, index) => {
            ...
            return (
              <button
                ...
                className={`group relative p-6 rounded-2xl ${metric.bgColor} border border-white/50 hover:shadow-lg hover:scale-[1.02] transition-all duration-300 text-left overflow-hidden`}
              >
